...
public final class ItemsRegistry {
    ...
    public static Item ELEMENT_WAND;
    ...
    public static void initialize() {
        ...
        MAGIC_CRYSTAL = register("magic_crystal", MagicCrystalItem::new, new Item.Settings());

        // 元素法杖
        ELEMENT_WAND = register("element_wand", ElementWandItem::new,
                new Item.Settings()
                        .maxCount(1)
                        .maxDamage(320));
