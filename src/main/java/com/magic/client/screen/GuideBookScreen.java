...
public class GuideBookScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        // 书页背景
        context.fill(x - 10, y - 10, x + 280, y + 200, 0xFF2D2D44);
        context.fill(x - 8, y - 8, x + 278, y + 198, 0xFF1E1E36);
        ...
        if (this.textRenderer != null) {
            ...
            context.drawText(this.textRenderer, pageStr,
                    x + 280 - this.textRenderer.getWidth(pageStr), y + 185, 0xFF888888, false);
        }
    ...
    private void renderTextPage(DrawContext context, int x, int y) {
        // page: 0→基础入门, 5→元素系统, 6→魔法阵与附魔
        int idx = page == 0 ? 0 : (page == 5 ? 1 : 2);
        int textY = y;
