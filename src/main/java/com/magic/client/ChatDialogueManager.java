...
public class ChatDialogueManager {
    ...
    private final String[] tutorials = {
        ...
        "§b8. 火元素攻击让生物着火",
        "§b9. 火+水（蒸发反应）：额外§c10-90§7伤害（血量低10-40，高50-90）",
        "§b    伤害越高几率越低，有几率连击2-4次",
        "§b10. 土元素攻击禁锢目标1-5秒",
        "",
        "§6【魔法阵】",
        "§b11. 传送法阵卷轴右键放置魔法阵（消耗50魔法值）",
        "§b12. 按 F7 传送回魔法阵（消耗10魔法值）",
        "§b13. 右键磨制花岗岩可收回魔法阵",
        "",
        "§6【其他物品】",
        "§b14. 水晶球：右键扫描附近生物，Shift+右键占卜运势",
        "§b15. 浮空魔法杖：右键生物使其悬浮",
        "§b16. 伤害魔法杖：蓄力后释放魔法伤害光束",
        "§b17. 魔法矿石在世界中生成，挖掘获得魔法水晶",
        "§b18. 魔法之星（合成材料）：击杀魔法僵尸获得"
    };
